...
## Project Structure
    ...
    ├── ben_mo_test_app_dev_22933  # Django project configurations
...
1. Clone this repo and `cd ben_mo_test_app_dev_22933`
...
2. Clone this repo and `cd ben_mo_test_app_dev_22933`
